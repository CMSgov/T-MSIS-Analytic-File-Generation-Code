...
%macro commoncols_base_line;
	...
	%do i=1 %to 2;
	  ...
	  %do j=1 %to 2;
		...
		,&ind1._&ind2._MDCR_CLM
		,&ind1._&ind2._MDCR_PD
		,&ind1._&ind2._OTHR_CLM
		,&ind1._&ind2._OTHR_PD
		,&ind1._&ind2._HH_CLM
		,&ind1._&ind2._HH_PD
...
/* Macro basecols: Lists variables in order per the final file layout specifications to be inserted in the permanent TAF table
*/
